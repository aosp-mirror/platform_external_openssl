...
# To regenerate, modify openssl.config, then run:
#    ./import_openssl.sh import /path/to/openssl-1.0.1e.tar.gz
## Before include this file, the local Android.mk must define the following
# variables:
#
#    local_c_flags
#    local_c_includes
