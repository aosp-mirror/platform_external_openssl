...
ifeq ($(HOST_OS),darwin)
  LOCAL_CLANG_ASFLAGS_arm := $(filter-out $(LOCAL_CLANG_ASFLAGS_arm),-no-integrated-as)
endif
...
ifeq ($(HOST_OS),darwin)
  LOCAL_CLANG_ASFLAGS_arm64 := $(filter-out $(LOCAL_CLANG_ASFLAGS_arm64),-no-integrated-as)
endif
...
ifeq ($(HOST_OS),darwin)
  LOCAL_CLANG_ASFLAGS_x86 := $(filter-out $(LOCAL_CLANG_ASFLAGS_x86),-no-integrated-as)
endif
...
ifeq ($(HOST_OS),darwin)
  LOCAL_CLANG_ASFLAGS_x86_64 := $(filter-out $(LOCAL_CLANG_ASFLAGS_x86_64),-no-integrated-as)
endif
...
ifeq ($(HOST_OS),darwin)
  LOCAL_CLANG_ASFLAGS_mips := $(filter-out $(LOCAL_CLANG_ASFLAGS_mips),-no-integrated-as)
endif
