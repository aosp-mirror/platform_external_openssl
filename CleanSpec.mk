...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/obj/*/libcrypto_*intermediates/export_includes $(OUT_DIR)/host/*/obj*/SHARED_LIBRARIES/libcrypto*intermediates/export_includes)
